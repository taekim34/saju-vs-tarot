...
${({'직업운': '【현재 주제 특화】 관성(정관/편관), 식상(식신/상관), 역마살에 특히 주목하세요. 적성, 승진 가능성, 이직 타이밍을 사주 구조로 분석하세요.',
'건강운': '【현재 주제 특화】 오행의 균형/불균형과 용신의 건강 영향에 주목하세요. 약한 오행이 어떤 장기에 영향을 줄 수 있는지, 사주 체질론 관점에서 분석하세요.',
'학업운': '【현재 주제 특화】 인성(정인/편인), 식상(식신/상관), 문창귀인에 주목하세요. 집중력, 학습 성향, 시험운을 사주 구조로 분석하세요.',
'대인관계': '【현재 주제 특화】 비겁(비견/겁재), 관성, 천을귀인에 주목하세요. 대인 성향, 갈등 요인, 좋은 인연의 시기를 분석하세요.'}[topic] || '')}
...
## 🗺️ 인생 로드맵 — 대운으로 보는 연령대별 흐름
대운 데이터를 바탕으로 과거→현재→미래를 연령대별로 풀어주세요 (8~15줄)
- 이미 지나간 대운: "이 시기에 이런 경험을 하셨을 거예요" (과거 검증 → 신뢰감)
- 현재 대운: "지금은 이런 에너지의 시기예요" (현재 상황 공감)
- 앞으로 올 대운: "이 시기에는 이런 흐름이 옵니다" (미래 기대감)
- 각 대운의 십성(편재/정관/식신 등)이 그 시기의 삶에 어떤 영향을 주는지 구체적으로
- 인생 전체의 큰 그림에서 "지금이 어디쯤인지" 조망해주세요

## ${currentYear}년 ${topic} 흐름과 타이밍
세운과 현재 대운이 올해 미치는 영향 5~7줄
- 올해 특히 좋은 시기와 조심할 시기
- 세운과 대운의 상호작용
...
${({'직업운': '【현재 주제 특화】 펜타클과 완드 수트, 세계/황제/마법사 카드에 특히 주목하세요. 커리어 방향성, 직장 에너지, 성장 기회를 카드로 읽어주세요.',
'건강운': '【현재 주제 특화】 검(소드) 수트, 탑/절제/별 카드에 주목하세요. 스트레스, 에너지 밸런스, 회복 신호를 카드로 읽어주세요.',
'학업운': '【현재 주제 특화】 소드 수트, 은둔자/마법사/여사제 카드에 주목하세요. 집중력, 지적 에너지, 시험 결과를 카드로 읽어주세요.',
'대인관계': '【현재 주제 특화】 컵 수트와 코트 카드에 주목하세요. 주변 인물 에너지, 관계 역학, 좋은 인연을 카드로 읽어주세요.'}[topic] || '')}
...
## 🗺️ 인생의 카드 여정
탄생 카드와 뽑힌 메이저 아르카나를 활용하여 인생의 큰 그림을 풀어주세요 (8~12줄)
- 탄생 카드(성격 카드 + 영혼 카드)가 말하는 "이 사람의 평생 테마"
- 뽑힌 메이저 아르카나의 번호가 바보의 여정(0→21) 중 어디인지 — "인생의 몇 번째 챕터"
- 점성술 대응(행성/별자리)이 있다면 현재 에너지 시기와 연결
- 타이밍 암시 데이터를 활용하여 가까운 미래의 속도감과 시기를 안내
- "지금까지 이런 여정을 걸어오셨고, 앞으로는 이런 방향입니다" 식의 시간적 조망
